...
class Todo extends Model {
  ...
  const Todo._internal({required this.id, required title, required isCompleted, createdAt, updatedAt}): _title = title, _isCompleted = isCompleted, _createdAt = createdAt, _updatedAt = updatedAt;
